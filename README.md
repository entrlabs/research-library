...
- The complete Zotero screening ledger and snapshots are intentionally private.
- `references.bib` and `CITATION.cff`: citation assets.
- `.github/workflows/`: validation and GitHub Pages workflows.

## Journal-ranking boundary

“Top journal” means top quartile by OpenAlex two-year mean citedness within the 21 journals represented in the shortlist. It is not an SJR/JCR quartile, is not field-normalized, and never affects an article’s evidence score.
